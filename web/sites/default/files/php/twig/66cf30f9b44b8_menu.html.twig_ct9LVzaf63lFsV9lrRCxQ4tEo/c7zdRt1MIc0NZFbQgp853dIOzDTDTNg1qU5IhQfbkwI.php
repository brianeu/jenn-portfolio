...
class __TwigTemplate_822f7079c2a57929d9d307d30a5d9d8d extends Template
{
    private $source;
    private $macros = [];
        ...
        return ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    yield "      <ul";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["nav"], "method", false, false, true, 33), 33, $this->source), "id"), "html", null, true);
                    yield ">
    ";
                } else {
                    // line 35
...
$context["item"], "url", [], "any", false, false, true, 51), "getOption", ["attributes"], "method", false, false, true, 51), "class", [], "any", false, false, true, 51)) ? (Twig\Extension\CoreExtension::join($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 51), "getOption", ["attributes"], "method", false, false, true, 51), "class", [], "any", false, false, true, 51), 51, $this->source), "")) : ("")), ("nav-link-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,                     // line 52
$context["item"], "url", [], "any", false, false, true, 52), "toString", [], "method", false, false, true, 52), 52, $this->source)))];
                    // line 55
                    yield "        ";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getLink($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "title", [], "any", false, false, true, 55), 55, $this->source), $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 55), 55, $this->source), ["class" => ($context["link_classes"] ?? null)]), "html", null, true);
                    yield "
        ";
                    // line 56
  ...
  ";
    ...
    {
        return array (  129 => 61,  122 => 59,  116 => 57,  114 => 56,  109 => 55,  107 => 52,  106 => 51,  105 => 50,  104 => 48,  99 => 46,  97 => 43,  96 => 42,  95 => 41,  94 => 39,  92 => 38,  87 => 37,  83 => 35,  77 => 33,  74 => 32,  71 => 31,  68 => 30,  54 => 29,  45 => 27,  42 => 22,  40 => 21,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/navigation/menu.html.twig", "C:\\xampp\\htdocs\\jenn-portfolio\\web\\themes\\contrib\\bootstrap_barrio\\templates\\navigation\\menu.html.twig");
    }
